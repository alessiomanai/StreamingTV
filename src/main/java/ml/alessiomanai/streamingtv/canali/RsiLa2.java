...
public class RsiLa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String html = "<html><body style=\"margin: 0; padding: 0;\"><div style=\"left: 0; width: 100%; height: 0; position: relative; padding-bottom: 56.0081%;\"><iframe src=\"https://ok.ru/videoembed/1853471530724?autoplay=1\" style=\"border: 0; top: 0; left: 0; width: 100%; height: 100%; position: absolute;\" allowfullscreen scrolling=\"no\" allow=\"encrypted-media\" ></iframe></div></body></html>";
