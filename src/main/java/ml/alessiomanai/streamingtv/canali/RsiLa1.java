...
public class RsiLa1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String html = "<html><body><div style=\"left: 0; width: 100%; height: 0; position: relative; padding-bottom: 56.0081%;\"><iframe src=\"https://ok.ru/videoembed/1812174544612?autoplay=1\" style=\"border: 0; top: 0; left: 0; width: 100%; height: 100%; position: absolute;\" allowfullscreen scrolling=\"no\" allow=\"encrypted-media\" ></iframe></div></body></html>";
